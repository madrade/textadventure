...
def cmd_look_around(context):
    current_room = context['room']
    show_room(context['world'][current_room])
            ...
            if item['name'] == params:
                if 'usable' in item['features']:
                    ...
                    # pouzitie novin
                        ...
                        if find_item('DVERE', context) is not None:
                            print(
                            ...
                            print('Nic zaujimave v novinach, iba zmizla osoba, ktora sa ti napadne podoba.')
...
commands = [
        ...
        {
            'description': 'Presunie sa do miestnosti na vychod.',
            'aliases': ('VYCHOD', 'EAST', 'E'),
            'exec': cmd_east
        },

        {
            'description': 'Presunie sa do miestnosti na zapad.',
            'aliases': ('ZAPAD', 'WEST', 'W'),
            'exec': cmd_west
        }
]
